...
export const ROLE_DEFINITIONS = [
  ...
  { key:"warehouse",    label:"Thủ kho",           color:"#92400e", bg:"#fef3c7", icon:"📦", sort_order:7,  description:"Quản lý xuất nhập tồn kho" },
  { key:"cashier",      label:"Thu ngân",          color:"#dc2626", bg:"#fee2e2", icon:"💰", sort_order:8,  description:"Thu tiền, bán hàng lẻ" },
  { key:"accountant",   label:"Kế toán",           color:"#2563eb", bg:"#dbeafe", icon:"📊", sort_order:9,  description:"Kế toán, báo cáo tài chính" },
  { key:"hr",           label:"Nhân sự",           color:"#d97706", bg:"#fef3c7", icon:"👥", sort_order:10, description:"Quản lý nhân viên, chấm công" },
  { key:"marketing",    label:"Marketing",         color:"#db2777", bg:"#fce7f3", icon:"📣", sort_order:11, description:"Quản lý media, chăm sóc khách hàng" },
  { key:"qa",           label:"QA / Kiểm soát CL", color:"#059669", bg:"#ecfdf5", icon:"✅", sort_order:12, description:"Kiểm soát chất lượng sửa chữa" },
  { key:"support",      label:"Hỗ trợ KT",         color:"#0891b2", bg:"#e0f9fe", icon:"🎧", sort_order:13, description:"Hỗ trợ kỹ thuật cấp 1" },
  { key:"delivery",     label:"Giao nhận",         color:"#6b7280", bg:"#f3f4f6", icon:"🚚", sort_order:14, description:"Giao nhận thiết bị" },
  { key:"it",           label:"IT / Dev",          color:"#374151", bg:"#f9fafb", icon:"💻", sort_order:15, description:"Quản trị hệ thống nội bộ" },
  { key:"viewer",       label:"Chỉ xem",           color:"#9ca3af", bg:"#f3f4f6", icon:"👁️", sort_order:16, description:"Xem báo cáo, không thao tác" },
  { key:"guest",        label:"Khách",             color:"#d1d5db", bg:"#f9fafb", icon:"🙋", sort_order:17, description:"Khách tra cứu đơn" },
];

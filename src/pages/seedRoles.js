...
export function buildPermissionRows() {
  const MATRIX = {
    owner:        { repair_order:p(1,1,1,1,1,1), repair_order_price:p(1,1,1,1,1,1), spare_part:p(1,1,1,1,1,1), stock_export:p(1,1,1,1,1,1), stock_import:p(1,1,1,1,1,1), stock_transfer:p(1,1,1,1,1,1), stock_count:p(1,1,1,1,1,1), stock_ledger:p(1,1,1,1,1,1), customer:p(1,1,1,1,1,1), sale_order:p(1,1,1,1,1,1), expense:p(1,1,1,1,1,1), revenue_report:p(1,0,0,0,0,1), staff:p(1,1,1,1,1,0), kpi:p(1,0,1,0,1,0), settings:p(1,0,1,0,0,0), media_post:p(1,1,1,1,1,1), notification:p(1,1,0,1,0,0), warehouse_mgr:p(1,1,1,1,1,0), supplier:p(1,1,1,1,1,1), debt:p(1,1,1,1,1,1), cash_journal:p(1,1,1,1,1,1), department:p(1,1,1,1,1,0) , pack_order:p(1,1,1,1,1,1), ship_order:p(1,1,1,1,1,1) },
    admin:        { repair_order:p(1,1,1,1,1,1), repair_order_price:p(1,1,1,1,1,1), spare_part:p(1,1,1,1,1,1), stock_export:p(1,1,1,1,1,1), stock_import:p(1,1,1,1,1,1), stock_transfer:p(1,1,1,1,1,1), stock_count:p(1,1,1,1,1,1), stock_ledger:p(1,1,1,1,1,1), customer:p(1,1,1,1,1,1), sale_order:p(1,1,1,1,1,1), expense:p(1,1,1,1,1,1), revenue_report:p(1,0,0,0,0,1), staff:p(1,1,1,0,1,0), kpi:p(1,0,1,0,1,0), settings:p(1,0,1,0,0,0), media_post:p(1,1,1,1,0,1), notification:p(1,1,0,1,0,0), warehouse_mgr:p(1,1,1,1,1,0), supplier:p(1,1,1,1,1,1), debt:p(1,1,1,1,1,1), cash_journal:p(1,1,1,1,1,1), department:p(1,1,1,1,1,0) , pack_order:p(1,1,1,1,1,1), ship_order:p(1,1,1,1,1,1) },
    manager:      { repair_order:p(1,1,1,1,1,1), repair_order_price:p(1,1,1,0,1,0), spare_part:p(1,1,1,0,1,1), stock_export:p(1,1,1,0,1,1), stock_import:p(1,1,0,0,1,1), stock_transfer:p(1,1,1,0,1,0), stock_count:p(1,1,1,0,1,0), stock_ledger:p(1,0,0,0,0,1), customer:p(1,1,1,0,0,1), sale_order:p(1,1,1,0,1,1), expense:p(1,1,1,0,1,1), revenue_report:p(1,0,0,0,0,1), staff:p(1,1,1,0,0,0), kpi:p(1,0,1,0,0,0), settings:p(1,0,0,0,0,0), media_post:p(1,1,1,0,0,1), notification:p(1,1,0,0,0,0), warehouse_mgr:p(1,1,1,0,0,0), supplier:p(1,1,1,0,1,1), debt:p(1,1,1,0,1,1), cash_journal:p(1,1,0,0,1,1), department:p(1,1,1,0,0,0) , pack_order:p(1,0,1,0,1,1), ship_order:p(1,0,1,0,1,1) },
    supervisor:   { repair_order:p(1,0,1,0,1,1), repair_order_price:p(1,0,0,0,1,0), spare_part:p(1,0,0,0,0,1), stock_export:p(1,0,1,0,1,1), stock_import:p(1,0,0,0,1,1), stock_transfer:p(1,0,0,0,1,0), stock_count:p(1,0,1,0,1,0), stock_ledger:p(1,0,0,0,0,1), customer:p(1,0,1,0,0,1), sale_order:p(1,0,0,0,1,1), expense:p(1,0,0,0,0,1), revenue_report:p(1,0,0,0,0,1), staff:p(1,0,0,0,0,0), kpi:p(1,0,1,0,1,0), settings:p(1,0,0,0,0,0), media_post:p(1,0,0,0,0,1), notification:p(1,1,0,0,0,0), warehouse_mgr:p(1,0,0,0,0,0), supplier:p(1,0,0,0,0,1), debt:p(1,0,0,0,1,1), cash_journal:p(1,0,0,0,0,1), department:p(1,0,0,0,0,0) , pack_order:p(1,0,1,0,1,0), ship_order:p(1,0,1,0,1,0) },
    receptionist: { repair_order:p(1,1,1,0,0,1), repair_order_price:p(1,1,0,0,0,0), spare_part:p(1,0,0,0,0,0), stock_export:p(1,1,0,0,0,0), stock_import:p(0,0,0,0,0,0), stock_transfer:p(0,0,0,0,0,0), stock_count:p(0,0,0,0,0,0), stock_ledger:p(1,0,0,0,0,0), customer:p(1,1,1,0,0,1), sale_order:p(1,1,0,0,0,1), expense:p(0,0,0,0,0,0), revenue_report:p(0,0,0,0,0,0), staff:p(0,0,0,0,0,0), kpi:p(0,0,0,0,0,0), settings:p(0,0,0,0,0,0), media_post:p(1,0,0,0,0,0), notification:p(1,0,0,0,0,0), warehouse_mgr:p(0,0,0,0,0,0), supplier:p(0,0,0,0,0,0), debt:p(0,0,0,0,0,0), cash_journal:p(0,0,0,0,0,0), department:p(0,0,0,0,0,0) , pack_order:p(0,0,0,0,0,0), ship_order:p(0,0,0,0,0,0) },
